model testPumpSingleCpipe
  ...
  ThermoPower.LHe.FMU.cpipe cpipe1(cpipe_input = "D:/Users/spinhalf.MICROWAVE/Work/FMIToolkits/test-cppfmu/src/fmu10/cpipe/_cpipe_core/test1.in", debugLogging = false, numberOfSteps = 20000, stopTime = 50) annotation(
...
equation
  ...
  annotation(
    ...
    Diagram(graphics = {Line(origin = {-39, -10}, points = {{-33, 6}, {33, 6}, {33, -6}})}));
