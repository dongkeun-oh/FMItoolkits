model testPumpTwoCpipes
  ...
  ThermoPower.LHe.FMU.cpipe cpipe1(cpipe_input = "C:/Users/spinhalf/FMIToolkits/test-cppfmu/src/fmu10/cpipe/_cpipe_core/test1.in", debugLogging = true, fmuContentsDir = "C:/Users/spinhalf/FMIToolkits/test-cppfmu/fmu10/release/cpipe", logLevel = 1, numberOfSteps = 40000, stopTime = 100.)  annotation(
    Placement(visible = true, transformation(origin = {0, 22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermoPower.LHe.FMU.cpipe cpipe2(cpipe_input = "C:/Users/spinhalf/FMIToolkits/test-cppfmu/src/fmu10/cpipe/_cpipe_core/test2.in", debugLogging = true, fmuContentsDir = "C:/Users/spinhalf/FMIToolkits/test-cppfmu/fmu10/release/cpipe", logLevel = 1, numberOfSteps = 40000, stopTime = 100.)  annotation(
